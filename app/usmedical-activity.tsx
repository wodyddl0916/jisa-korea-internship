...
const copy = {
  ko: {
    ...
    reviewCards: [
      ...
      ["LANGUAGE", "일본어의 필요성과 후배에게 전할 조언", "첫 주에는 일본어 소통을 도와주는 학생이 있었지만, 이후 직접 소통하면서 어려움을 느꼈습니다. 특히 일상회화와 업무회화는 사용하는 표현이 달라, 후배들에게는 기본 회화뿐 아니라 업무에서 자주 쓰는 일본어도 미리 준비해 오기를 권하고 싶습니다."],
    ],
    ...
    preparation: [
      ...
      ["결제", <>일본에서도 대부분의 매장에서 카드 결제가 가능했습니다. 다만 일부 음식점이나 소규모 매장은 <strong>현금 또는 교통카드만 가능한 경우</strong>가 있어 소액의 현금을 함께 준비하면 좋습니다.</>],
  ...
  ja: {
    label: "US MEDICAL · STUDENT ACTIVITY",
    title: <>朝鮮大学校 × US Medical <br />実習活動記録</>,
    ...
    duties: [
      ...
      ["03", "キャラクター企画", "マスコットのパチィちゃんと口腔環境を舞台にした世界観、広告シナリオを企画しました。"],
      ["04", "AI広告動画", "Google Flow用のシーン別プロンプトを設計し、生成・選定・修正を重ねて広告動画を完成させました。"],
    ],
    processLabel: "02 · VIDEO PRODUCTION PROCESS",
    ...
    reviewLabel: "05 · REFLECTION & OUTCOMES",
    reviewTitle: <>体験の振り返りと<br />成果</>,
    reviewCards: [
      ["EXPERIENCE", "インターンシップに参加して感じたこと", "授業や個人制作だけでは得にくい日本企業の業務環境を実際に体験しました。開発だけでなく、デザイン、広告、マーケティング、利用者の視点を合わせて考えることが、製品を効果的に伝えるために重要だと学びました。"],
      ...
      ["SATISFACTION", "参加して良かったか", "今回の日本インターンシップに参加して本当に良かったと感じています。韓国では得にくい日本企業の働き方と海外生活を体験し、大学で学んだ技術を実際の会社と製品のための成果物に活用できました。"],
      ["HIGHLIGHTS", "特に良かった点", "単なる旅行や短期体験では分かりにくい日本での仕事と生活を約9週間にわたって直接経験できました。また、企業担当者からのフィードバックを反映して成果物を修正する過程を通じ、実際の業務の進め方に加えて、デザインやマーケティングの視点まで学ぶことができました。"],
      ["LANGUAGE", "日本語の必要性と後輩への助言", "最初の週は日本語でのコミュニケーションを手助けしてくれる学生がいましたが、その後、自分で直接やり取りする中で難しさを感じました。特に日常会話と業務会話では使われる表現が異なるため、後輩には基本会話だけでなく、仕事でよく使う日本語も事前に準備しておくことを勧めたいです。"],
    ],
    calendarLabel: "06 · 9-WEEK ACTIVITY CALENDAR",
    calendarTitle: <>9週間の<br />インターンシップ活動記録</>,
    ...
    weeks: [
      ...
      ["WEEK 07", "08.10 — 08.16", "フィードバック反映・修正", "人物と製品の形、シーンのつながり、メッセージの伝わり方を確認し、企業担当者の意見を反映して繰り返し修正しました。", "フィードバック・修正過程"],
    ...
    preparation: [
      ...
      ["決済", <>日本でも多くの店舗でカード決済を利用できました。ただし、一部の飲食店や小規模店舗では<strong>現金または交通系ICカードのみ利用できる場合</strong>があるため、少額の現金も用意しておくと安心です。</>],
    ...
    reflection: <>
      ...
      <strong>AIツールへ目的に合った指示を出し、結果を判断する力</strong>と最後まで改善を続ける実務姿勢を身につけました。
      <br /><br />
      ...
      今回の経験から、コンテンツ制作の能力だけでなく、協働、コミュニケーション、スケジュール管理、生活への適応も学びました。
    ...
    gratitude: <>
      ...
      新しい環境に慣れながら業務を学べるよう温かく支えてくださったUS Medicalの代表者・社員の皆様に、心より感謝申し上げます。
      <br /><br />
      ...
      <br /><br />
      今回のインターンシップを通じて、技術の使い方だけでなく、企業の目的と消費者の視点から考えること、
