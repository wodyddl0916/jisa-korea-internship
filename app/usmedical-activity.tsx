...
const copy = {
  ko: {
    ...
    lifeCards: [
      ...
      ["PERSONAL TIME", "개인 시간 활용", "업무 외 시간에는 지역 도서관이나 카페를 찾아 개인적인 학습과 자기계발 시간을 보냈으며, 자연스럽게 일본의 공공시설과 카페 문화도 함께 경험했습니다.", "library"],
  ...
  ja: {
    ...
    lifeCards: [
      ...
      ["PERSONAL TIME", "個人時間の活用", "業務時間外には地域の図書館やカフェを訪れ、個人学習や自己啓発の時間を過ごしました。その中で、日本の公共施設やカフェ文化にも自然に触れることができました。", "library"],
