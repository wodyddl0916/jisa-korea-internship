...
export default function KoreanPartnershipPage() {
  return <>
    ...
    <section className="section operationsSection"><div className="wrap"><SectionHeading label="PROGRAM OPERATIONS" title="관리 체계와 지원 내용을 하나의 운영으로 공유합니다." text="대학과 JISA, 수용 기업이 역할을 나누고 준비부터 수료 이후까지 지속적으로 지원합니다." /><div className="operationGrid">
