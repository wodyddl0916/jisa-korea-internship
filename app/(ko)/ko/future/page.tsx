...
export default function KoreanFuturePage() {
  return <>
    <PageHero index="05" label="VISION 2026–2027" title="한국 내 사업 기반을 강화해 배움부터 취업까지 지원합니다." intro="HRD Korea와의 협력을 중심으로 한국 현지 운영 체계, 대학·기업 네트워크, 일본 취업 희망자를 위한 커리큘럼 사업을 단계적으로 확대합니다." />
