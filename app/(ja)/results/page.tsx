...
export default function ResultsPage() {
  return <>
    ...
    <section className="section soft"><div className="wrap"><SectionHeading label="PROGRAM RECORDS" title="セミナー、来日、面接を映像で確認できます。" text="各大学の入国セミナー、参加者インタビュー、空港での来日記録など、提供資料に記載された映像リンクです。" />
